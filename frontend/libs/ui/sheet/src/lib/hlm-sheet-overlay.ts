...
export class HlmSheetOverlay {
  ...
  protected readonly _computedClass = computed(() =>
    hlm(
      'data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 isolate bg-black/10 text-xs/relaxed duration-100 supports-backdrop-filter:backdrop-blur-xs',
      this.userClass(),
    ),
  );
